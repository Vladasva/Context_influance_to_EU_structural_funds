...
def runTCDF(datafile):
    ...
    for c in columns:
        ...
        causes, causeswithdelay, realloss, scores, all_scores = TCDF.findcauses(c, cuda=cuda, epochs=nrepochs,
...
def plotgraph(stringdatafile,alldelays,columns):
    ...
    nx.draw_networkx(G,pos, node_color = 'white', edge_color='black',node_size=1000,with_labels = True)
    ax = plt.gca()
